  ...
  class AddLangGenerator < Rails::Generators::Base
    ...
    def add_lang
      ...
      langs.each do |lang|
        ...
        language_supported = TranslationCenter::TranslationKey.column_names.include?("#{lang.underscore}_status")
        ...
        migration_template 'migrations/add_lang_status_translation_keys.rb',
          "db/migrate/add_#{lang.underscore}_status_translation_center_translation_keys.rb"
      end
